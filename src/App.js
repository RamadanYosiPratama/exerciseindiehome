...
function App() {
  return (
    <div className="wrapperapp">
      <Navbar />
      <Isi img1={require('./props/slider1.jpg')} img2={require('./props/sliderr.jpg')} img3={require('./props/slider2.jpg')}
      img4={require('./props/sliderr.jpg')} img5={require('./props/slider2.jpg')} img6={require('./props/slider1.jpg')}
